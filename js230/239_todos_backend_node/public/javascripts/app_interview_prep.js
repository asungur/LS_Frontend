$(function () {
  ...
  const App = (() => {
    ...
    // IMPLEMENT SIDEBARCLICK WITHOUT JQ FOR THE INTERVIEW 
    function handleSidebarClick2() {
      UI.sideBar.addEventListener("click", e => {
        e.preventDefault();

        let subSection = e.target.closest("section").id;
        let sectionTitle = UI.getTitleFromTag(e.target.closest("dl"));
