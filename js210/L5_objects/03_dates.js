...
let dayMessage = 'Today\'s day is ' + String(today.getDay());
...
let weekDayMessage = 'Today\'s day is ' + daysOfWeek[today.getDay()];
...
let dateMessage = ', the ' + String(today.getDate());

// console.log(weekDayMessage + dateMessage);
...
let suffixedMessage = weekDayMessage + ', the ' + dateSuffix(String(today.getDate()));

// console.log(suffixedMessage);
...
let monthMessage = weekDayMessage + ', ' + String(today.getMonth()) + ' ' + dateSuffix(String(today.getDate()));
...
let monthIdxMessage = weekDayMessage + ', ' + months[today.getMonth()] + ' ' + dateSuffix(String(today.getDate()));

// console.log(monthIdxMessage);
